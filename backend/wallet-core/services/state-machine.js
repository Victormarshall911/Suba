...
const TransitionMap = {
  [States.INITIATED]: [States.PAYMENT_PENDING, States.FAILED, States.FLAGGED_FRAUD],
  [States.PAYMENT_PENDING]: [States.PAYMENT_CONFIRMED, States.FAILED, States.FLAGGED_FRAUD],
  [States.PAYMENT_CONFIRMED]: [States.PROCESSING, States.FLAGGED_FRAUD],
  [States.PROCESSING]: [States.FULFILLED, States.FAILED, States.FLAGGED_FRAUD],
  [States.FLAGGED_FRAUD]: [States.MANUAL_REVIEW, States.FAILED],
  [States.MANUAL_REVIEW]: [States.PROCESSING, States.FULFILLED, States.FAILED],
  [States.FULFILLED]: [States.REVERSED],
  [States.FAILED]: [],
  [States.REVERSED]: []
};
